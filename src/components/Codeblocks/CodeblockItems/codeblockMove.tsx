...
const CodeBlockMove = (props : pr) => {
    ...
    <>
        {vis?
            <Codeblock Name={"ロボットを移動させる"} AlternativeName='ロボットをいどうさせる' id={props.data.id} index={props.index} GroupIndex={props.GroupIndex} icon={<ControlCameraIcon sx={{color:"#505050"}}/>} Delete={props.Delete} setVis={setVis}>
                <Box sx={{ minWidth: 120 }}>
